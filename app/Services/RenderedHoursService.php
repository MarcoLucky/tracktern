...
class RenderedHoursService
{
    ...
    public function calculateStudentProgress(Student $student, ?int $classroomId = null): array
    {
        ...
        return [
            ...
            'course_code' => $student->course ? $student->course->course_code : 'N/A',
            'profile_photo_url' => $student->profile_photo_url,
            'company_name' => $student->company_name ?? 'N/A',
            'organization_location' => $student->organization_location ?? 'N/A',
            'internship_start_date' => $student->internship_start_date ? $student->internship_start_date->toDateString() : 'N/A',
            'internship_end_date' => $student->internship_end_date ? $student->internship_end_date->toDateString() : 'N/A',
